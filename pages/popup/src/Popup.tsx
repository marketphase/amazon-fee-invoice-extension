      ...
      <main className="popup-page__content">
        <div className="popup-page__text">
          ...
          <ol>
            ...
            <li><span>Select the date range for the invoices you want to download</span></li>
            <li><span>Click the Staxxer button that appears on the right side of the page</span></li>
            <li><span>Filter the invoices if needed</span></li>
            <li><span>Click "Download" to get your invoices as a ZIP file</span></li>
          </ol>
        </div>
      </main>
